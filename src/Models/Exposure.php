 ...
 *
 * Blatt des Gefährdungs-Clusters (FK → Hazard). service_id ist eine LOSE Referenz auf
 * encounter_services — die Brücke zur Person-Seite (occupational/encounter).
 *
 * @ai.description Gefährdungsfaktor je erbrachter Leistung mit eigenem Fristen-Recall.
 */
class Exposure extends Model
{
    protected $table = 'customer_exposures';
    ...
    /**
     * Erbrachte Leistung — LOSE Referenz auf encounter (Person-Seite), kein DB-FK.
     */
