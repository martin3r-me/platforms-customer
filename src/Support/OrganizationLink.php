...
/**
 * OrganizationLink — hält den dimension_link eines customer-Objekts auf seinen
 * Betrieb-Org-Entity synchron (genau EIN Knoten je Objekt: external_customer ODER
 * eine Kind-Abteilung). Setzt/ändert/entfernt den Link in der "entity"-Dimension.
 * Fehlertolerant (blockiert Saves nicht, falls Org fehlt). Anker-Prinzip.
 */
