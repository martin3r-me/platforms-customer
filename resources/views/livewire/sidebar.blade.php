{{--
    Customer · Sidebar (nx-Design-System). Nur var(--nx-*) Tokens.
--}}
...
<div>
    ...
    <x-ui-sidebar-list label="Betriebe">
        <x-ui-sidebar-item :href="route('customer.dashboard')">
            @svg('heroicon-o-home', 'w-4 h-4 text-[var(--nx-text)]')
            <span class="ml-2 text-sm">Dashboard</span>
        </x-ui-sidebar-item>
        <x-ui-sidebar-item :href="route('customer.companies.index')">
